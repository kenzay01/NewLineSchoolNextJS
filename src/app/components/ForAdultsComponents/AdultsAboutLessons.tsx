...
export default function AdultsAboutLessons() {
  ...
  return (
    <div className="for-adults-about-lessons-container">
      <motion.div
        className="for-adults-about-lessons-info-left"
      ...
      >
        <div className="for-adults-about-lessons-info-left-title-con">
          ...
          <div className="for-adults-about-lessons-info-left-img">
            <img
              loading="lazy"
              src="/assets/elements/star_rounded.png"
              alt="Star"
            />
          </div>
        </div>
        <div className="for-adults-about-lessons-info-left-body">
          ...
          <div className="for-adults-about-lessons-info-left-body-p">
            Кожний наш курс має певну кількість годин. Але якщо наприкінці
            вибраного вами рівня ви відчули, що потребуєте більше практики, ми
            надалі будемо працювати з вами і розробляти особливо для вас курс.
          </div>
        </div>
      </motion.div>
      <motion.div
        className="for-adults-about-lessons-info-right"
